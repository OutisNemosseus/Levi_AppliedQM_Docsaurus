---
title: Chapter 8 - Exercise 7B - LaTeX
sidebar_label: Ex7b-latex
---

# Chapter 8 - Exercise 7B - LaTeX Document

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/programs/latex/Chapt8Exercise7b/Chapt8Exercise7b.tex" download="Chapt8Exercise7b.tex"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .tex
  </a>
  <a href="/programs/latex/Chapt8Exercise7b/Chapt8Exercise7b.tex" target="_blank" rel="noopener noreferrer"
