---
title: Chapter 8 - Fig 15 - MATLAB
sidebar_label: Fig15-matlab
---

# Chapter 8 - Fig 15 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt8Fig15/Chapt8Fig15.m" download="Chapt8Fig15.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt8Fig15/Chapt8Fig15.m" target="_blank" rel="noopener noreferrer"
