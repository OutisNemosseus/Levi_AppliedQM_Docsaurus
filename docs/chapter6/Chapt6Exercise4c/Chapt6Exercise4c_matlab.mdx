---
title: Chapter 6 - Exercise 4C - MATLAB
sidebar_label: Ex4c-matlab
---

# Chapter 6 - Exercise 4C - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt6Exercise4c/Chapt6Exercise4c.m" download="Chapt6Exercise4c.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt6Exercise4c/Chapt6Exercise4c.m" target="_blank" rel="noopener noreferrer"
