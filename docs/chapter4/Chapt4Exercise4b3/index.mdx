---
title: Chapter 4 - Exercise 4B3
sidebar_label: Chapter 4 - Exercise 4B3
---

# Chapter 4 - Exercise 4B3
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt4Exercise4b3.m`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt4Exercise4b3_matlab"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/matlab/Chapt4Exercise4b3/Chapt4Exercise4b3.m"
      download="Chapt4Exercise4b3.m"
      style={{
        padding: '6px 12px',
