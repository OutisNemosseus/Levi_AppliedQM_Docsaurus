---
title: Chapter 4 - Exercise 2B - MATLAB
sidebar_label: Ex2b-matlab
---

# Chapter 4 - Exercise 2B - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt4Exercise2b/Chapt4Exercise2b.m" download="Chapt4Exercise2b.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt4Exercise2b/Chapt4Exercise2b.m" target="_blank" rel="noopener noreferrer"
