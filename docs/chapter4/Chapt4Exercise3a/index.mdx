---
title: Chapter 4 - Exercise 3A
sidebar_label: Chapter 4 - Exercise 3A
---
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt4Exercise3a.m`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt4Exercise3a_matlab"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/matlab/Chapt4Exercise3a/Chapt4Exercise3a.m"
      download="Chapt4Exercise3a.m"
      style={{
        padding: '6px 12px',
