---
title: Chapter 4 - Exercise 3B - MATLAB
sidebar_label: Ex3b-matlab
---

# Chapter 4 - Exercise 3B - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt4Exercise3b/Chapt4Exercise3b.m" download="Chapt4Exercise3b.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt4Exercise3b/Chapt4Exercise3b.m" target="_blank" rel="noopener noreferrer"
