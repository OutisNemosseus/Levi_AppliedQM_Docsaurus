---
title: Chapter 4 - Exercise 7A - MATLAB
sidebar_label: Ex7a-matlab
---

# Chapter 4 - Exercise 7A - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt4Exercise7a/Chapt4Exercise7a.m" download="Chapt4Exercise7a.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt4Exercise7a/Chapt4Exercise7a.m" target="_blank" rel="noopener noreferrer"
