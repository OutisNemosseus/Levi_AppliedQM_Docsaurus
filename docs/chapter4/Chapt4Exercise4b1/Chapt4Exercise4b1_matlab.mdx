---
title: Chapter 4 - Exercise 4B1 - MATLAB
sidebar_label: Ex4b1-matlab
---

# Chapter 4 - Exercise 4B1 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt4Exercise4b1/Chapt4Exercise4b1.m" download="Chapt4Exercise4b1.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt4Exercise4b1/Chapt4Exercise4b1.m" target="_blank" rel="noopener noreferrer"
...
[← Back to Chapter 4 - Exercise 4B1](./)
