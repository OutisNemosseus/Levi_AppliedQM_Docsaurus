---
title: Chapter 4 - Exercise 4B2 - MATLAB
sidebar_label: Ex4b2-matlab
---

# Chapter 4 - Exercise 4B2 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt4Exercise4b2/Chapt4Exercise4b2.m" download="Chapt4Exercise4b2.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt4Exercise4b2/Chapt4Exercise4b2.m" target="_blank" rel="noopener noreferrer"
...
[← Back to Chapter 4 - Exercise 4B2](./)
