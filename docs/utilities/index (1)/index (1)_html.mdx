...
<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/programs/html/index (1)/index (1).html" download="index (1).html"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download HTML
  </a>
  <a href="/programs/html/index (1)/index (1).html" target="_blank" rel="noopener noreferrer"
...
<iframe
  src="/programs/html/index (1)/index (1).html"
  width="100%"
  height="800px"
  style={{
...
<body>
  <header class="header">
    <h1>📚 Program Docs Generator <span class="badge">v2.0</span></h1>
  </header>
  ...
  <nav class="sidebar">
    <div class="sidebar-section">
      ...
      <ul class="sidebar-nav">
        <li><a href="#overview" class="active" onclick="showPage('overview')"><span class="nav-icon">🏠</span>Overview</a></li>
        <li><a href="#architecture" onclick="showPage('architecture')"><span class="nav-icon">🏗️</span>Architecture</a></li>
        <li><a href="#solid" onclick="showPage('solid')"><span class="nav-icon">💎</span>SOLID Principles</a></li>
      </ul>
    </div>
    <div class="sidebar-section">
      <div class="sidebar-title">Modules</div>
      <div class="nav-group">
        <div class="nav-group-header" onclick="toggleGroup(this)"><span><span class="nav-icon">⚙️</span>Config</span><span class="arrow">▼</span></div>
        <ul class="nav-group-items sidebar-nav"><li><a href="#config" onclick="showPage('config')">index.js</a></li></ul>
      </div>
      <div class="nav-group">
        <div class="nav-group-header" onclick="toggleGroup(this)"><span><span class="nav-icon">🔧</span>Utils</span><span class="arrow">▼</span></div>
      ...
      <div class="nav-group">
        <div class="nav-group-header" onclick="toggleGroup(this)"><span><span class="nav-icon">🔍</span>Parsers</span><span class="arrow">▼</span></div>
        <ul class="nav-group-items sidebar-nav">
      ...
      <div class="nav-group">
        <div class="nav-group-header" onclick="toggleGroup(this)"><span><span class="nav-icon">🎨</span>Generators</span><span class="arrow">▼</span></div>
        <ul class="nav-group-items sidebar-nav">
      ...
      <div class="nav-group">
        <div class="nav-group-header" onclick="toggleGroup(this)"><span><span class="nav-icon">⚡</span>Services</span><span class="arrow">▼</span></div>
        <ul class="nav-group-items sidebar-nav">
    ...
    <div class="sidebar-section">
      ...
      <ul class="sidebar-nav"><li><a href="#testing" onclick="showPage('testing')"><span class="nav-icon">🧪</span>Unit Tests</a></li></ul>
    </div>
    <div class="sidebar-section">
      <div class="sidebar-title">API Reference</div>
      <ul class="sidebar-nav"><li><a href="#api" onclick="showPage('api')"><span class="nav-icon">📖</span>Full API</a></li></ul>
    </div>
  </nav>
...
npm test         # Run tests</code></pre>
      ...
      <div id="architecture" class="page">
        ...
        <div class="architecture">
          <div class="arch-layer"><div class="arch-box primary"><div class="icon">🎯</div><div class="label">CLI Entry</div></div></div>
          <div class="arch-arrow">↓</div>
          <div class="arch-layer"><div class="arch-box"><div class="icon">🏭</div><div class="label">Application</div></div></div>
          <div class="arch-arrow">↓</div>
          <div class="arch-layer">
            <div class="arch-box"><div class="icon">⚡</div><div class="label">Services</div></div>
            <div class="arch-box"><div class="icon">🎨</div><div class="label">Generators</div></div>
            <div class="arch-box"><div class="icon">🔍</div><div class="label">Parsers</div></div>
          </div>
          <div class="arch-arrow">↓</div>
          <div class="arch-layer">
            <div class="arch-box"><div class="icon">🔧</div><div class="label">Utilities</div></div>
            <div class="arch-box"><div class="icon">⚙️</div><div class="label">Config</div></div>
          </div>
        </div>
        <h2>Directory Structure</h2>
        <div class="module-tree"><span class="folder">src/</span>
├── <span class="folder">config/</span>
│   └── <span class="file">index.js</span>         <span class="comment"># Configuration</span>
├── <span class="folder">utils/</span>
│   ├── <span class="file">stringUtils.js</span>   <span class="comment"># String functions</span>
│   ├── <span class="file">fileSystem.js</span>    <span class="comment"># FS abstraction</span>
│   └── <span class="file">logger.js</span>        <span class="comment"># Logging</span>
├── <span class="folder">parsers/</span>
│   ├── <span class="file">programParser.js</span> <span class="comment"># Filename parsing</span>
│   └── <span class="file">fileClassifier.js</span><span class="comment"># Type classification</span>
├── <span class="folder">generators/</span>
│   ├── <span class="file">templateBuilder.js</span><span class="comment"># MDX components</span>
│   ├── <span class="file">pageGenerators.js</span><span class="comment"># Page strategies</span>
│   └── <span class="file">sidebarGenerator.js</span><span class="comment"># Sidebar config</span>
├── <span class="folder">services/</span>
│   ├── <span class="file">documentProcessor.js</span><span class="comment"># Orchestrator</span>
│   ├── <span class="file">cleanService.js</span>  <span class="comment"># Cleanup</span>
│   └── <span class="file">watchService.js</span>  <span class="comment"># File watching</span>
├── <span class="file">app.js</span>             <span class="comment"># DI container</span>
└── <span class="file">index.js</span>           <span class="comment"># CLI entry</span></div>
      </div>
      ...
      <div id="solid" class="page">
        ...
        <div class="principle-grid">
          <div class="principle-card" style="background: linear-gradient(135deg, #f093fb, #f5576c);"><h4>🎯 Single Responsibility</h4><p>Each module has one reason to change.</p></div>
          <div class="principle-card" style="background: linear-gradient(135deg, #4facfe, #00f2fe);"><h4>🔓 Open/Closed</h4><p>New file types without modifying existing code.</p></div>
          <div class="principle-card" style="background: linear-gradient(135deg, #43e97b, #38f9d7);"><h4>🔄 Liskov Substitution</h4><p>All generators implement same interface.</p></div>
          <div class="principle-card" style="background: linear-gradient(135deg, #fa709a, #fee140);"><h4>🎛️ Interface Segregation</h4><p>Small, focused interfaces.</p></div>
          <div class="principle-card" style="background: linear-gradient(135deg, #667eea, #764ba2);"><h4>💉 Dependency Inversion</h4><p>Dependencies via injection.</p></div>
        </div>
...
getFileTypeConfig('.m'); // { type: 'matlab', ... }</code></pre>
        ...
        <table>
          ...
          <tbody>
            <tr><td>.m</td><td>matlab</td><td>✅</td></tr>
            <tr><td>.tex</td><td>latex</td><td>✅</td></tr>
            <tr><td>.pdf</td><td>pdf</td><td>❌</td></tr>
            <tr><td>.html</td><td>html</td><td>✅</td></tr>
            <tr><td>.ipynb</td><td>ipynb</td><td>❌</td></tr>
            <tr><td>.txt</td><td>text</td><td>✅</td></tr>
          </tbody>
        </table>
      </div>
...
const sidebarJs = generator.generate(byChapterMap);</code></pre>
      ...
      <div id="svc-doc" class="page">
        ...
        <p><code>src/services/documentProcessor.js</code> - Main orchestra
