---
title: chempot - MATLAB
sidebar_label: chempot-matlab
---
...
<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  ...
  <a href="/programs/matlab/chempot/chempot.m" download="chempot.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/chempot/chempot.m" target="_blank" rel="noopener noreferrer"
