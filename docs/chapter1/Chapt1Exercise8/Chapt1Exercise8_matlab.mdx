---
title: Chapter 1 - Exercise 8 - MATLAB
sidebar_label: Ex8-matlab
---

# Chapter 1 - Exercise 8 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt1Exercise8/Chapt1Exercise8.m" download="Chapt1Exercise8.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt1Exercise8/Chapt1Exercise8.m" target="_blank" rel="noopener noreferrer"
