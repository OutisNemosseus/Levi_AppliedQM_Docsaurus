---
title: Chapter 9 - Fig 6A1 - MATLAB
sidebar_label: Fig6a1-matlab
---

# Chapter 9 - Fig 6A1 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt9Fig6a1/Chapt9Fig6a1.m" download="Chapt9Fig6a1.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt9Fig6a1/Chapt9Fig6a1.m" target="_blank" rel="noopener noreferrer"
