---
title: Chapter 9 - Fig 6A2 - LaTeX
sidebar_label: Fig6a2-latex
---

# Chapter 9 - Fig 6A2 - LaTeX Document

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/programs/latex/Chapt9Fig6a2/Chapt9Fig6a2.tex" download="Chapt9Fig6a2.tex"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .tex
  </a>
  <a href="/programs/latex/Chapt9Fig6a2/Chapt9Fig6a2.tex" target="_blank" rel="noopener noreferrer"
