---
title: Chapter 9 - Fig 6B - LaTeX
sidebar_label: Fig6b-latex
---

# Chapter 9 - Fig 6B - LaTeX Document

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/programs/latex/Chapt9Fig6b/Chapt9Fig6b.tex" download="Chapt9Fig6b.tex"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .tex
  </a>
  <a href="/programs/latex/Chapt9Fig6b/Chapt9Fig6b.tex" target="_blank" rel="noopener noreferrer"
