---
title: Chapter 9 - Exercise 5 - MATLAB
sidebar_label: Ex5-matlab
---

# Chapter 9 - Exercise 5 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt9Exercise5/Chapt9Exercise5.m" download="Chapt9Exercise5.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt9Exercise5/Chapt9Exercise5.m" target="_blank" rel="noopener noreferrer"
