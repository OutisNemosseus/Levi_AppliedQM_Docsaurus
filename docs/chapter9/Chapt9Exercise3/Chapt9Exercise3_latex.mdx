---
title: Chapter 9 - Exercise 3 - LaTeX
sidebar_label: Ex3-latex
---

# Chapter 9 - Exercise 3 - LaTeX Document

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>
  <a href="/programs/latex/Chapt9Exercise3/Chapt9Exercise3.tex" download="Chapt9Exercise3.tex"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .tex
  </a>
  <a href="/programs/latex/Chapt9Exercise3/Chapt9Exercise3.tex" target="_blank" rel="noopener noreferrer"
...
\item Absorption tail affects internal l
```
