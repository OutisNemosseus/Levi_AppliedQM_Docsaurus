...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt9Exercise1.tex`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt9Exercise1_latex"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/latex/Chapt9Exercise1/Chapt9Exercise1.tex"
      download="Chapt9Exercise1.tex"
      style={{
        padding: '6px 12px',
        backgroundColor: '#10b981',
        color: 'white',
...
```latex title="Chapt9Exercise1.tex"
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt9Exercise1.pdf`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt9Exercise1_pdf"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/pdf/Chapt9Exercise1/Chapt9Exercise1.pdf"
      download="Chapt9Exercise1.pdf"
      style={{
        padding: '6px 12px',
        backgroundColor: '#10b981',
        color: 'white',
...
<iframe
  src="/programs/pdf/Chapt9Exercise1/Chapt9Exercise1.pdf"
  width="100%"
  height="900px"
