...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt7Fig6b.tex`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt7Fig6b_latex"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/latex/Chapt7Fig6b/Chapt7Fig6b.tex"
      download="Chapt7Fig6b.tex"
      style={{
        padding: '6px 12px',
        backgroundColor: '#10b981',
        color: 'white',
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt7Fig6b.pdf`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt7Fig6b_pdf"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/pdf/Chapt7Fig6b/Chapt7Fig6b.pdf"
      download="Chapt7Fig6b.pdf"
      style={{
        padding: '6px 12px',
        backgroundColor: '#10b981',
        color: 'white',
...
<iframe
  src="/programs/pdf/Chapt7Fig6b/Chapt7Fig6b.pdf"
  width="100%"
  height="900px"
