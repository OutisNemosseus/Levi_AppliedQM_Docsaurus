...
sidebar_label: Chapter 7 - Exercise 3
---
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt7Exercise3.m`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt7Exercise3_matlab"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/matlab/Chapt7Exercise3/Chapt7Exercise3.m"
      download="Chapt7Exercise3.m"
      style={{
        padding: '6px 12px',
...
```matlab title="Chapt7Exercise3.m"
