---
title: Chapter 7 - Exercise 3 - MATLAB
sidebar_label: Ex3-matlab
---

# Chapter 7 - Exercise 3 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt7Exercise3/Chapt7Exercise3.m" download="Chapt7Exercise3.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt7Exercise3/Chapt7Exercise3.m" target="_blank" rel="noopener noreferrer"
