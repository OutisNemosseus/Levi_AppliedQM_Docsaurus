---
title: Chapter 7 - Fig 3 - MATLAB
sidebar_label: Fig3-matlab
---

# Chapter 7 - Fig 3 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt7Fig3/Chapt7Fig3.m" download="Chapt7Fig3.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt7Fig3/Chapt7Fig3.m" target="_blank" rel="noopener noreferrer"
