---
title: Chapter 3 - Fig 14 - MATLAB
sidebar_label: Fig14-matlab
---

# Chapter 3 - Fig 14 - MATLAB Code

<div style={{display: 'flex', gap: '12px', flexWrap: 'wrap', marginBottom: '24px'}}>

  <a href="/programs/matlab/Chapt3Fig14/Chapt3Fig14.m" download="Chapt3Fig14.m"
    style={{padding: '10px 20px', backgroundColor: '#10b981', color: 'white', borderRadius: '6px', textDecoration: 'none', fontWeight: 'bold'}}>
    📥 Download .m
  </a>
  <a href="/programs/matlab/Chapt3Fig14/Chapt3Fig14.m" target="_blank" rel="noopener noreferrer"
