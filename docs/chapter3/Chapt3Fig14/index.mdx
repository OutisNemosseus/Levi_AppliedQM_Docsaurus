---
title: Chapter 3 - Fig 14
sidebar_label: Chapter 3 - Fig 14
---
...
<div style={{
  ...
  <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px'}}>
    ...
    <div>
      ...
      <div style={{fontSize: '12px', color: '#666'}}>`Chapt3Fig14.m`</div>
    </div>
  </div>
  <div style={{display: 'flex', gap: '8px', flexWrap: 'wrap'}}>
    <a
      href="./Chapt3Fig14_matlab"
      style={{
        padding: '6px 12px',
    ...
    <a
      href="/programs/matlab/Chapt3Fig14/Chapt3Fig14.m"
      download="Chapt3Fig14.m"
      style={{
        padding: '6px 12px',
